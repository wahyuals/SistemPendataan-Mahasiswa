	...
	<div class="gambar">
		<div class="container">
			<div class="card">
				...
				<div class="card-body" style="background-image: url('assets/img/unri.jpeg');background-repeat: no-repeat;
	background-size: 100%;">
					<div class="text1 h1 text-center text-black mb-auto">Sistem</div>
					<div class="text2 h3 text-center text-black mb-auto">Pendataan</div>
					<div class="text2 h3 text-center text-black mb-auto">Mahasiswa</div>
					<div class="mt-5">
						...
						@session_start();
						if (@$_SESSION['email']): ?>
							<a href="system/informasi_surat/index.php" style="text-decoration-line: none;"><button type="button" class="btn btn-warning btn-lg btn-block text-black mb-2">Kembali Ke Halaman Sistem</button></a>
